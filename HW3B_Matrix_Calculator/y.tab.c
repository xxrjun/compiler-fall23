...
{
  "$end", "error", "$undefined", "MATRIX", "ADD", "SUB", "MUL",
  "TRANSPOSE", "LPAREN", "RPAREN", "$accept", "expression", "term",
  "factor", 0
};
#endif
